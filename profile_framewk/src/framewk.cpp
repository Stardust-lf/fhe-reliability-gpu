...
int main(int argc, char *argv[])
{
    ...
    if (argc != 2)
    {
        cout << "Usage: ./performance_test <mode>" << endl;
        cout << "  1. BFV default" << endl;
        cout << "  2. BFV custom" << endl;
        cout << "  3. CKKS default" << endl;
        cout << "  4. CKKS custom" << endl;
        cout << "  5. BGV default" << endl;
        cout << "  6. BGV custom" << endl;
        return 1;
    }
